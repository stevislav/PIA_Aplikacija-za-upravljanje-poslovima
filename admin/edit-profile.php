      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <form action="update-profile.php?id_user=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
            <?php
            //Sql za logovanje
              ...
              <div class="row">
                ...
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" id="contactno" name="contactno" placeholder="Broj" value="<?php echo $row['contactno']; ?>">
                  </div>
                  <div class="form-group">
