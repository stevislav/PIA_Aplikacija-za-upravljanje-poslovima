        ...
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="pull-right">
              <a href="active-jobs.php" class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-left"></i> Nazad</a>
            </div>
          ...
          <div class="col-md-3">
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <p><a href="../company.php?id=<?php echo $row['id_company'];?>" class="btn btn-primary btn-flat" role="button">Više informacija</a>
              </div>
            </div>
          </div>
        </div>
