      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Kompanija</i></h2>
            <div class="row">
              <form action="update-company.php?id_company=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
                <?php
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <label for="state">Okrug</label>
                    <input type="text" class="form-control input-lg" id="state" name="state" placeholder="Okrug" value="<?php echo $row['state']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Promeni logo kompanije</label>
