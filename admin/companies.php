            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="companies.php"><i class="fa fa-building"></i> Kompanije</a></li>
                      ...
                      <tr>
                        ...
                        <?php
                          if($row['active'] == '1') {
                            ...
                            ?>
                            <a href="reject-company.php?id=<?php echo $row['id_company']; ?>">Odbij</a> <a href="approve-company.php?id=<?php echo $row['id_company']; ?>">Prihvati</a>
                            <?php
                          } else if ($row['active'] == '3') {
                            ?>
                              <a href="approve-company.php?id=<?php echo $row['id_company']; ?>">Reaktiviraj</a>
                            <?php
                        ...
                        <td><a href="edit-company.php?id=<?php echo $row['id_company']; ?>"><i class="fa fa-edit"></i></a></td>
