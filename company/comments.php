        ...
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="comments.php"><i class="fa fa-comment"></i> Komentari</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="row">
              <div class="col-md-20">
			  <?php
                    $sql = "SELECT * FROM comments WHERE id_company='$_SESSION[id_company]'";
                ...
                <div class="info-box bg-teal">
                  <span class="info-box-icon bg-blue"><i class="ion ion-ios-contact"></i></span>
          <br>
				  <?php 
				  $temp=$row['rating'];
				  while($temp>0){
					  ?>					  
					   <img src="../img/star.png" alt="star" style="width:20px;height:20px;"> 
					   <?php
					   $temp=$temp-1;
				  }
				  ?>
                  <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $row['comment'];?></span>
