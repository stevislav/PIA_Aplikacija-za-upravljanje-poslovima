      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Izmena oglasa</i></h2>
            <div class="row">
              <form method="post" action="changepost.php?id_company=<?php echo $_SESSION['id_company']; ?>&id_post=<?php echo $_GET['id']; ?>">
			  <?php
                ...
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group">
                    <textarea class="form-control input-lg" id="description" name="description" value="<?php echo $row['description']; ?>"></textarea>
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control  input-lg" id="minimumsalary" autocomplete="off" name="minimumsalary" value="<?php echo $row['minimumsalary']; ?>" required="">
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control  input-lg" id="maximumsalary" name="maximumsalary" value="<?php echo $row['maximumsalary']; ?>" required="">
                  </div>
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" value="<?php echo $row['experience']; ?>" required="">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="qualification" name="qualification" value="<?php echo $row['qualification']; ?>" required="">
                  </div>
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-primary">Izmena</button>
                  </div>
                </div>
				                 <?php
                    }
